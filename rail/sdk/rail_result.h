...
enum RailResult {
    ...
    kErrorUserSpaceV2QueriedSpaceWorksAmountExceedLimit = 1022069,  // the amount of queried
                                                                    // spaceworks exceed the limit.
    ...
    // text input
    kErrorTextInputTextInputSendMessageToPlatformFailed = 1040000,  // deprecated
    kErrorTextInputTextInputSendMessageToOverlayFailed = 1040001,  // deprecated
    kErrorTextInputTextInputUserCanceled = 1040002,  // deprecated
    kErrorTextInputTextInputEnableChineseFailed = 1040003,  // deprecated
    kErrorTextInputTextInputShowFailed = 1040004,  // deprecated
    kErrorTextInputEnableIMEHelperTextInputWindowFailed = 1040005,  // deprecated
    ...
    kErrorInGameCoinConfigurationNotAvailable = 1045005,  // in-game coin configuration not available  
