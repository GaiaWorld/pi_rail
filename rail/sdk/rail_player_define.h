...
// deprecated
// after accessing the new anti-addiction rules, the RailAntiAddictionGameOnlineTimeChanged
// callback event is no longer needed. Please register the RailCustomizeAntiAddictionActions
// callback event to get the anti-addiction tips.
